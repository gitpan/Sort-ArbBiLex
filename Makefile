# This Makefile is for the Sort::ArbBiLex extension to perl.
#
...
#	NAME => q[Sort::ArbBiLex]
#	VERSION_FROM => q[ArbBiLex.pm]
...
AR_STATIC_ARGS = cr
NAME = Sort::ArbBiLex
DISTNAME = Sort-ArbBiLex
NAME_SYM = Sort_ArbBiLex
VERSION = 3.1
VERSION_SYM = 3_1
XS_VERSION = 3.1
INST_BIN = ./blib/bin
...
FULLEXT = Sort/ArbBiLex
BASEEXT = ArbBiLex
PARENT_NAME = Sort::
DLBASE = $(BASEEXT)
VERSION_FROM = ArbBiLex.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Sort
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Sort
...
TO_INST_PM = ArbBiLex.pm

PM_TO_BLIB = ArbBiLex.pm \
	$(INST_LIBDIR)/ArbBiLex.pm
...
manifypods : ArbBiLex.pm
	@$(POD2MAN) \
	ArbBiLex.pm \
	$(INST_MAN3DIR)/Sort::ArbBiLex.$(MAN3EXT)
